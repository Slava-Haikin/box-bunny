...
import { ingredientsTable, recipeIngredientsTable, recipesTable, recipeTagEnum, usersTable } from '@/data/db/schema';
  ...
  const recipes = [
    {
      ...
      instructions: ['Add oats to a pot and boil it for 10 minutes.', 'Pour milk, add peanut butter and greek yoghurt.', 'Let sit overnight.', 'Add crushed peanuts and chia seeds (optionally)'],
      meal: MEAL.breakfast,
    ...
    },
    {
      ...
      instructions: ['Boil buckwheat.', 'Sauté carrots, onions, and garlic.', 'Add ground chicken and tomato paste.', 'Combine with buckwheat.'],
      meal: MEAL.lunch,
    ...
    },
    {
      ...
      instructions: ['Boil rice and lentils.', 'Fry onions.', 'Combine with rice and lentils.'],
      meal: MEAL.supper,
      difficulty: COOKING_DIFFICULTY.medium,
